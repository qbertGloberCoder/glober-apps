...
public class TimeSetSequence implements SequenceElementI {
	private ObservationTime observationTime;
	private long unixTimeInMillis;
	
	public TimeSetSequence(ObservationTime observationTime, long unixTimeInMillis) {
	...
	public void update() throws UninitializedObject {
		observationTime.setUnixTime(unixTimeInMillis);
	}
