...
public class SetLatLonBiasSequence implements SequenceElementI {
	private CoordinateBias coordinateBias;
	
	private double newMultiplier;
	private double newOffset;
	
	public SetLatLonBiasSequence(CoordinateBias coordinateBias, double newMultiplier, double newOffset) {
	...
	public void update() throws UninitializedObject {
		coordinateBias.setMultiplier(newMultiplier);
		coordinateBias.setOffset(newOffset);
	}
