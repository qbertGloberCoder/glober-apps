...
import me.qbert.skywatch.ui.renderers.MercatorScrollImageRenderer;
...
public class MercatorObjects extends AbstractCelestialObjects {
	...
	public MercatorObjects(Canvas canvas) throws Exception {
		super(canvas);
	}
	...
	protected void locationChanged(double latitude, double longitude) {
		mercatorImageRenderer.wrapToCoordinates(0);
	}
	...
	protected void setClockLHA(double localHourAngle) {
		...
		clockRenderer.setAspectRatioOverride(mercatorImageRenderer.getAspectRatio());
