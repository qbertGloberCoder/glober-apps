...
import me.qbert.mapper.services.projections.EquirectilinearTransform;
import me.qbert.mapper.ui.components.Canvas;

public class EquirectilinearObjects extends AbstractProjectionObject {
	public EquirectilinearObjects(Canvas canvas, AnimationConfiguration animationConfiguration) throws Exception {
